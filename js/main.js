...
function insertCustomArrowImages() {
  ...
  const arrows = [
    {
      ...
      data: {
        productImage: "imgs/DermatologyPacks.jpg",
        productImage1: "imgs/DermatologyPacks.jpg",
        productImage2: "imgs/DermatologyPacks.jpg",

        benefits: [
          {
            title: "Feature 5",
            description:
              "A range of Dermatological  products formulated for the treatment of various skin conditions, including infections and allergies.",
          },
        ],
        benefits2: [
          {
  ...
  arrows.forEach((arrow) => {
    ...
    label.style.top = `calc(${arrow.top} + -30px)`;
